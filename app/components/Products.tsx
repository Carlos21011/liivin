...
export default function Products() {
  ...
  // =========================================================
  // 1. MOTOR DE ANIMACIÓN LIGERO (Aparición en Cascada)
  // =========================================================
  useEffect(() => {
  ...
  // =========================================================
  // 2. LÓGICA DEL CARRUSEL (Autoplay Móvil + Puntos Activos)
  // =========================================================
  useEffect(() => {
  ...
  return (
    <section id="productos" className="w-full bg-brand-offwhite py-24 px-6 lg:px-12 relative border-t border-brand-oak/20 overflow-hidden">
      <div className="max-w-[1400px] mx-auto">
        ...
        {/* ========================================================= */}
        {/* CARRUSEL MÓVIL / GRID ESCRITORIO (Los 3 Productos)        */}
        {/* ========================================================= */}
        <div 
        ...
        >
          ...
          <div className="min-w-[90%] sm:min-w-[70%] lg:min-w-0 snap-center bg-white border border-brand-oak/30 flex flex-col justify-between hover:shadow-xl transition-all duration-700 group relative product-reveal opacity-0 translate-y-12 delay-[100ms] ease-out overflow-hidden rounded-sm">
            ...
            <div className="p-8 lg:p-10 border-b border-brand-oak/20 bg-brand-offwhite/30 flex flex-col items-center text-center">
              <p className="text-brand-olive tracking-[0.2em] text-[10px] font-bold uppercase mb-4">Ebook 01</p>
              <h3 className="text-2xl font-serif text-brand-cedar mb-2">El Despertar</h3>
              <p className="text-brand-taupe font-sans text-xs mb-6 h-12">El arte de LIDERAR tu hogar aunque tú no estés.</p>
            ...
            <div className="p-8 lg:p-10 flex flex-col flex-grow">
              ...
              <ul className="space-y-3 mb-8 flex-grow">
                ...
                <li className="flex items-start gap-3 text-xs text-brand-taupe leading-relaxed"><span className="text-brand-olive">✓</span> Herramientas para conocer tu casa antes de delegarla.</li>
                <li className="flex items-start gap-3 text-xs text-brand-taupe leading-relaxed"><span className="text-brand-olive">✓</span> Construcción de equipo y sostén de armonía.</li>
                <li className="flex items-start gap-3 text-xs text-brand-taupe leading-relaxed"><span className="text-brand-olive">✓</span> 5 scripts para conversaciones difíciles.</li>
              </ul>
              
              <div className="bg-brand-cedar/5 p-4 rounded-sm border border-brand-oak/20 mb-8">
                <p className="text-brand-cedar font-bold text-[10px] tracking-widest uppercase mb-2">Bonus:</p>
                <p className="text-xs text-brand-taupe mb-2"><strong className="font-medium text-brand-cedar">✓ Empatía en casa:</strong> Ensayo editorial.</p>
                <p className="text-xs text-brand-taupe"><strong className="font-medium text-brand-cedar">✓ Home Excel:</strong> Plantilla descargable de gestión.</p>
              </div>
          ...
          <div className="min-w-[90%] sm:min-w-[70%] lg:min-w-0 snap-center bg-white border border-brand-oak/30 flex flex-col justify-between hover:shadow-xl transition-all duration-700 group relative product-reveal opacity-0 translate-y-12 delay-[300ms] ease-out overflow-hidden rounded-sm">
            ...
            <div className="p-8 lg:p-10 border-b border-brand-oak/20 bg-brand-offwhite/30 flex flex-col items-center text-center">
              <p className="text-brand-olive tracking-[0.2em] text-[10px] font-bold uppercase mb-4">Ebook 02</p>
              <h3 className="text-2xl font-serif text-brand-cedar mb-2">El Llamado</h3>
              <p className="text-brand-taupe font-sans text-xs mb-6 h-12">El arte de TRANSFORMAR tu hogar desde la acción.</p>
              <div className="text-4xl font-serif text-brand-cedar">USD 12</div>
            </div>
            ...
            <div className="p-8 lg:p-10 flex flex-col flex-grow">
              <p className="text-brand-cedar font-bold text-xs tracking-widest uppercase mb-4">Qué Incluye:</p>
              <ul className="space-y-3 mb-8 flex-grow">
                <li className="flex items-start gap-3 text-xs text-brand-taupe leading-relaxed"><span className="text-brand-olive">✓</span> Guía de depuración consciente.</li>
                <li className="flex items-start gap-3 text-xs text-brand-taupe leading-relaxed"><span className="text-brand-olive">✓</span> Organización con propósito.</li>
                <li className="flex items-start gap-3 text-xs text-brand-taupe leading-relaxed"><span className="text-brand-olive">✓</span> Rituales que sostienen el método a largo plazo.</li>
                <li className="flex items-start gap-3 text-xs text-brand-taupe leading-relaxed"><span className="text-brand-olive">✓</span> Acción sin presión, pero con constancia.</li>
              </ul>
              
              <div className="bg-brand-cedar/5 p-4 rounded-sm border border-brand-oak/20 mb-8">
                <p className="text-brand-cedar font-bold text-[10px] tracking-widest uppercase mb-2">Bonus:</p>
                <p className="text-xs text-brand-taupe mb-2"><strong className="font-medium text-brand-cedar">✓ Menús:</strong> 8 semanas de menús listos.</p>
                <p className="text-xs text-brand-taupe"><strong className="font-medium text-brand-cedar">✓ Mercado:</strong> Lista de mercado inteligente.</p>
              </div>
          ...
          <div className="min-w-[90%] sm:min-w-[70%] lg:min-w-0 snap-center bg-white border border-brand-oak/30 flex flex-col justify-between hover:shadow-xl transition-all duration-500 group relative product-reveal opacity-0 translate-y-12 delay-[500ms] ease-out overflow-hidden rounded-sm">
            ...
            <div className="p-8 lg:p-10 border-b border-brand-oak/20 bg-brand-offwhite/30 flex flex-col items-center text-center">
              <p className="text-brand-olive tracking-[0.2em] text-[10px] font-bold uppercase mb-4">Manual Premium</p>
              <h3 className="text-2xl font-serif text-brand-cedar mb-2">La Capacitación</h3>
              <p className="text-brand-taupe font-sans text-xs mb-6 h-12">El método, ahora a cuatro manos con tu equipo.</p>
              <div className="text-4xl font-serif text-brand-cedar">USD 30</div>
            </div>
            
            <div className="p-8 lg:p-10 flex flex-col flex-grow">
              <p className="text-brand-cedar font-bold text-xs tracking-widest uppercase mb-4">3 Módulos de Entrenamiento:</p>
              <ul className="space-y-4 mb-8 flex-grow">
                <li>
                  <p className="text-xs font-bold text-brand-cedar leading-none mb-1"><span className="text-brand-olive mr-1">01.</span> Cuidado General</p>
                  <p className="text-[11px] text-brand-taupe leading-relaxed">Limpieza, manejo de productos y tendido de camas.</p>
                </li>
                <li>
                  <p className="text-xs font-bold text-brand-cedar leading-none mb-1"><span className="text-brand-olive mr-1">02.</span> Detalles que Transforman</p>
                  <p className="text-[11px] text-brand-taupe leading-relaxed">Cuidado de ropa, platería, plantas, etiqueta y protocolo.</p>
                </li>
                <li>
                  <p className="text-xs font-bold text-brand-cedar leading-none mb-1"><span className="text-brand-olive mr-1">03.</span> Organización Profesional</p>
                  <p className="text-[11px] text-brand-taupe leading-relaxed">Organización de closets, nevera, despensa y lencería.</p>
                </li>
              </ul>
              
              <div className="bg-transparent p-4 h-[84px] mb-8">
                 {/* Espaciador invisible para alinear el botón */}
              </div>
